export const texts = {
  en: {
    ...
    endTitle: 'Finish screen title (optional)',
    endTitlePlaceholder: 'Override default "Game Complete!" title',
  ...
  he: {
    ...
    endTitle: 'כותרת מסך סיום (אופציונלי)',
    endTitlePlaceholder: 'מחליף את ברירת המחדל "סיום משחק!"',
