export const texts = {
  en: {
    ...
    nudgeParticipantsBody:
      "{count} players are still in progress. Send a reminder or let the manager restart the room flow.",
    groupGap: "Group performance gap",
    groupGapBody:
      "{top} leads {low} by {gap} score points. Use this in the debrief and check whether weaker groups missed a station.",
    readyForClient: "Ready for client reporting",
    readyForClientBody:
      "Completion, score, and player activity are all in a presentable range for a client or boss summary.",
    ...
    excludeHint:
      "Unchecked players are removed from all statistics — the dashboard panels, the Excel exports, and the public share link. Reversible at any time.",
    ...
    resetParticipantConfirm:
      "Reset progress for {name}? This will clear their saved score and send them back to the start.",
    resetProgressFailed: "Could not reset progress. Please try again.",
    ...
    reportCardHint:
      'Each row is one person matched across the selected activities (by email, phone, or name). The final grade is the average of their grades in the activities they played; "—" means they didn\'t play that one.',
    ...
    combinedReportsHint:
      "Every download bundles the cross-activity views (report card + all participants) with each selected activity's full report.",

    // Pass grade
    passGrade: "Pass grade",
    passGradeDesc:
      "Participants whose normalized score (0-100) is at or above this value count as passing in reports and statistics. Choose None to skip pass/fail entirely.",
    passGradeNone: "None",

    // Share link
    shareTitle: "Share statistics page",
    shareDesc:
      "Anyone with this link can view this activity's statistics and download the reports (including participant names, emails and phone numbers) — with no access to the admin panel.",
  ...
  he: {
    ...
    nudgeParticipantsBody:
      "{count} שחקנים עדיין בתהליך. כדאי לשלוח תזכורת או לאפשר למנהל להחזיר את הזרימה למסלול.",
    groupGap: "פער בין קבוצות",
    groupGapBody:
      "{top} מובילה על {low} בפער של {gap} נקודות. השתמש בזה בתחקיר ובדוק אם הקבוצות החלשות פספסו תחנה.",
    readyForClient: "מוכן לדוח לקוח",
    readyForClientBody:
      "ההשלמה, הציונים ופעילות השחקנים נמצאים בטווח שניתן להציג ללקוח או מנהל.",
    ...
    excludeHint:
      "שחקנים שאינם מסומנים מוסרים מכל הסטטיסטיקות — מהפאנלים בלוח הבקרה, מקובצי האקסל ומקישור השיתוף הציבורי. ניתן לבטל בכל רגע.",
    ...
    resetting: "מאפס...",
    resetParticipantConfirm:
      "לאפס את ההתקדמות של {name}? זה ינקה את הניקוד השמור וישלח אותם להתחלה.",
    resetProgressFailed: "לא ניתן לאפס את ההתקדמות. נסה שוב.",
    ...
    reportCardHint:
      'כל שורה היא משתתף אחד שזוהה לאורך הפעילויות שנבחרו (לפי אימייל, טלפון או שם). הציון הסופי הוא ממוצע הציונים שלו בפעילויות שבהן השתתף; "—" מסמן שלא השתתף בפעילות הזו.',
    exportReportCard: "גליון ציונים",
    exportReportCardDescription: "ציון סופי לכל משתתף בכל הפעילויות",
    combinedReports: "דוחות",
    combinedReportsHint:
      "כל הורדה כוללת את התצוגות החוצות-פעילויות (גליון ציונים + כל המשתתפים) יחד עם הדוח המלא של כל פעילות שנבחרה.",

    // Pass grade
    passGrade: "ציון מעבר",
    passGradeDesc:
      'משתתפים שהציון המנורמל שלהם (0-100) שווה לערך הזה או גבוה ממנו ייחשבו כעוברים בדוחות ובסטטיסטיקות. בחירה ב"ללא" מבטלת את חישוב העובר/נכשל.',
    passGradeNone: "ללא",

    // Share link
    shareTitle: "שיתוף דף הסטטיסטיקה",
    shareDesc:
      "כל מי שיש לו את הקישור יכול לצפות בסטטיסטיקה של הפעילות ולהוריד את הדוחות (כולל שמות, אימיילים וטלפונים של המשתתפים) — ללא גישה לפאנל הניהול.",
