...
export const texts = {
  he: {
    ...
    faq: [
      ...
      { q: 'כמה זמן לוקח להקים ולהשיק פעילות?', a: 'לאחר אפיון צרכים מהיר, פעילות המבוססת על תבנית יכולה לעלות לאוויר תוך 1-2 שבועות. התאמה ופיתוח מלאים נמשכים מספר שבועות בודדים.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'How long does it take to build and launch?', a: 'After a quick needs assessment, a template-based activity can go live within 1-2 weeks. Full customisation and development take just a few weeks.' },
